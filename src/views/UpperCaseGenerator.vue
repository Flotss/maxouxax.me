        ...
        <main>
            ...
            <div class="whycontainer">
                <div class="why">
                    ...
                    <p class="about">UpperCaseGenerator est un mini-service vous permettant de transformer vos phrases en quelques instants dans une forme rEsSeMbLaNt à Ça :)</p>
